...
/*window.addEventListener("load",()=>{
    ...
    form.addEventListener("submit",(e)=>{
        let error="";
        e.preventDefault();
        const name=document.querySelector("[name=nameField]");
        const lastName=document.querySelector("[name=lastNameField]");
        const email=document.querySelector("[name=emailField]");
        const telephone=document.querySelector("[name=telephone]");
        const password=document.querySelector("[name=passwordField]");
        const repeatPassword=document.querySelector("[name=repeatPasswordField]");
